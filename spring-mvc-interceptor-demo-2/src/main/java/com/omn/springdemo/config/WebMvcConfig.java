package com.omn.springdemo.config;
...
import com.omn.springdemo.interceptors.ExecutionTimerInterceptor;
import com.omn.springdemo.interceptors.HeaderInterceptor;

@Configuration
@ComponentScan("com.omn.springdemo")
@EnableWebMvc
