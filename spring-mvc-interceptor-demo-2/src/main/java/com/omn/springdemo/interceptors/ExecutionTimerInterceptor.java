package com.omn.springdemo.interceptors;
...
public class ExecutionTimerInterceptor implements HandlerInterceptor {
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler,
		...
		HANDLER_EXECUTION_TIME = POSTHANDLE_TIME - PREHANDLE_TIME;
		TOTAL_EXECUTION_TIME = AFTER_COMPLETION_TIME - PREHANDLE_TIME;
